...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('admin/images/library.png')}}">
    @yield('css')
    ...
    <script src=" https://cdn.ckeditor.com/4.14.0/full/ckeditor.js" charset="utf-8"></script>
...
<div id="main-wrapper">
    ...
    <div class="footer">
        <div class="copyright pt-0">
            <p>Copyright © Hava limanı {{ date('Y') }}</p>
        </div>
    </div>
